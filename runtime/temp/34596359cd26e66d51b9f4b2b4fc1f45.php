<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\myweb\tp0301/application/admin\view\role\roleadd.html";i:1532591145;s:50:"D:\myweb\tp0301/application/admin\view\layout.html";i:1531811546;}*/ ?>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p class="level">
									...
									<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
										...
										<input type="checkbox" name="level[]" value="<?php echo $v['id']; ?>"><?php echo $v['name']; ?></b>
...
$('.level b').click(function(){
	...
	$(this).parent().find('span input').prop('checked',true)
}else{
	//取消
	////子灭
	$(this).parent().find('span input').prop('checked',false)
}
})
...
$('.level span input').click(function(){
	...
	if($(this).is(":checked")){
		...
		if(i==0){
			$(this).parent().parent().find('b input').prop('checked',false)
		}
	}
	////取消
})
