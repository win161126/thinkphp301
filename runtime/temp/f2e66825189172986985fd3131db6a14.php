<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\myweb\tp0301/application/admin\view\category\catelist.html";i:1532592648;s:50:"D:\myweb\tp0301/application/admin\view\layout.html";i:1531811546;}*/ ?>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<center>
							<ul class="">
								<li><span><a href="<?php echo url('Category/cateList',['page'=>($page-1)]); ?>"><<</a></span></li>
								<?php for($i=1;$i<=$pnum;$i++){?>
								<li><span><a href="<?php echo url('Category/cateList',['page'=>$i]); ?>"><?php echo $i;?></a></span></li>
								<?php }?>
								<li><span><a href="<?php echo url('Category/cateList',['page'=>($page+1)]); ?>">>></a></span></li>
							</ul>
						</center>
